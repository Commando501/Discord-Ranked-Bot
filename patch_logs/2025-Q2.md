...
**Changes**:
- Removed the redundant Players tab from the Admin page since the web panel is designed for admin access only
- Enhanced the Players page with more comprehensive player editing capabilities
- Added additional admin controls to the player edit dialog including win/loss and streak management
- Improved the layout for clearer data organization
- Added cross-navigation references between admin panels

**Purpose**: Consolidate duplicate functionality between the admin settings page and player profiles page to provide a more unified admin experience

**Testing**: Verified that all player management functionality previously available in the admin page is now accessible through the enhanced Players page

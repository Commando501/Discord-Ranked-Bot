...
export default function LoginPage() {
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#36393F]">
      <Card className="w-[350px] bg-[#2F3136] border-none shadow-lg">
        <CardHeader className="space-y-1">
          <CardTitle className="text-2xl text-white font-semibold">Admin Login</CardTitle>
        ...
        <CardContent className="grid gap-4">
          <div className="relative">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-[#2F3136] px-2 text-gray-400">Discord Authentication</span>
            </div>
          </div>
          <Button 
